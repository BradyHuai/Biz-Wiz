# Generated by Django 3.1.2 on 2020-11-30 05:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[('IT', 'IT')], max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('business_name', models.CharField(default='', max_length=80)),
                ('application_name', models.CharField(default='', max_length=80)),
        ...
        migrations.CreateModel(
            name='Business',
            fields=[
                ('user_profile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='main.userprofile')),
                ('business_name', models.CharField(max_length=80)),
                ('website', models.URLField(null=True)),
                ('short_paragraph', models.TextField()),
                ('image', models.ImageField(blank=True, null=True, upload_to='businessImages')),
            ],
        ),
        migrations.CreateModel(
            name='Individual',
