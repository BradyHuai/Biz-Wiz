...
export default function SignUpPage() {
  ...
  //data states
  const [options, updateOptionData] = React.useState({cities: [], industries: []});
  ...
  return <div className="container">
    ...
    <div className={classes.signUp}>
      ...
      <h1 className={classes.label} style={{paddingBottom: "1%"}}>Business Account</h1>
      ...
      <form style={{padding: "10px"}} onSubmit={(e) => {
        ...
        <label className={classes.label} for="businessName">Business Name:</label>
        <input className={classes.input} id="businessName" type="text" onChange={(e) => {setValues((current) => ({...current, "business_name": e.target.value}));}}/>
        ...
        <label className={classes.label} for="industry">Industry: </label>
        <select className={classes.input} id="industry" onChange={(e) => {setValues((current) => ({...current, "industry": e.target.value}));}}>
        ...
        <label className={classes.label} for="address">Address:</label>
        <input className={classes.input} id="address" type="text" onChange={(e) => {setValues((current) => ({...current, "address": e.target.value}));}}/>

        <label className={classes.label} for="postalCode">Postal Code:</label>
        <input className={classes.input} id="postalCode" type="text" onChange={(e) => {setValues((current) => ({...current, "zip_code": e.target.value}));}}/>

        <label className={classes.label} for="city">City:</label>
        <select className={classes.input} id="city" onChange={(e) => {setValues((current) => ({...current, "city": e.target.value}));}}>
          <option value="" disabled selected>Select a City</option>
          <option value="IT">Toronto</option>
          {getEntries(options.cities)}
        </select>

        <label className={classes.label} for="description">Short description of your company:</label>
